...
export function Header() {
  return (
    <header className="w-full border-b-2 border-ink sticky top-0 z-50 bg-paper/66 backdrop-blur-md">
        ...
        <nav className="flex items-center gap-1 sm:gap-2">
          <Button variant="ghost" size="lg" asChild>
            <Link href="/" className="gap-2">
              ...
              <span className="hidden sm:inline font-bold">Vote</span>
              <span className="sr-only sm:hidden">Vote</span>
            </Link>
          </Button>
          <Button variant="ghost" size="lg" asChild>
